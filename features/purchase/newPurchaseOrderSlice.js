  ...
  async (data, thunkApi) => {
    try {
      ...
      console.log('json data', data);
         ...
         const response = await axios.post('http://192.168.1.6:2000/api/purchase', formData, {
          headers: {
...
export const {PurchaseDetail, addMaterial, addSupplierSign, addDriverSign,addPhotoUri} =
  postPurchaseSlice.actions;
